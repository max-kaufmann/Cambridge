...
import uk.ac.cam.cl.mk2030.exercises.Exercise10;
import uk.ac.cam.cl.mk2030.exercises.Exercise12;
...
public class Exercise12Tester {
    static final Path graphFile = Paths.get("data/file.txt");
    ...
    public static void main(String[] args) throws IOException {
        ...
        Map<Integer, Set<Integer>> graph2 = ex10.loadGraph(graphFile);
        System.out.println("Clusters:");
        System.out.println(clustering);
        System.out.println();
    }
