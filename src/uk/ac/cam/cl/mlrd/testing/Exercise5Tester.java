...
import uk.ac.cam.cl.mk2030.exercises.Exercise5;
...
public class Exercise5Tester {
    ...
    static final Path testDirectory = Paths.get("D:/Cambridge/CompSci/1A/MLRWD/Task 1/data/sentiment_test_set");
    static final Path newDataDirectory = Paths.get("D:/Cambridge/CompSci/1A/MLRWD/Task 1/data/year_2016_dataset");
    ...
    public static void main(String[] args) throws IOException {
        ...
        Map<Path,Sentiment> lexiconResultsNew = e1.improvedClassifier(newTestSet.keySet(),Path.of("D:/Cambridge/CompSci/1A/MLRWD/Task 1/data/sentiment_lexicon.txt"));
        Map<Path,Sentiment> lexiconResultsOld = e1.improvedClassifier(testSet.keySet(),Path.of("D:/Cambridge/CompSci/1A/MLRWD/Task 1/data/sentiment_lexicon.txt"));
        System.out.println("Held Out: " + + e1.calculateAccuracy(testSet,lexiconResultsOld));
        System.out.println("2016: " + e1.calculateAccuracy(newTestSet,lexiconResultsNew));
    }
}