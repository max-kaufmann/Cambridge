...
import uk.ac.cam.cl.mk2030.exercises.Exercise6;
...
public class Exercise6Tester {
    ...
    static final Path dataDirectory = Paths.get("D:/Cambridge/CompSci/1A/MLRWD/Task 1/data/nuanced_sentiment_dataset");
